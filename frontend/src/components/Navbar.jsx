...
const Navbar = () => {
  ...
  // Smooth scroll helper — respects scroll-margin-top set in CSS
  const scrollTo = (id, e) => {
    e.preventDefault();
  ...
  return (
    ...
    >
      <div className="nav-logo">
        <a href="#home" onClick={e => scrollTo('home', e)}>S</a>
      </div>

      <div className="nav-links">
        <a href="#skills" className="nav-link" onClick={e => scrollTo('skills', e)}>
          <Cpu className="nav-icon" /> SKILLS
        </a>
        <a href="#projects" className="nav-link" onClick={e => scrollTo('projects', e)}>
          <Rocket className="nav-icon" /> PROJ
        </a>
        <a href="#training" className="nav-link" onClick={e => scrollTo('training', e)}>
          <Code className="nav-icon" /> TRAIN
        </a>
        <a href="#achievements" className="nav-link" onClick={e => scrollTo('achievements', e)}>
          <Award className="nav-icon" /> ACHV
        </a>
        <a href="#certificates" className="nav-link" onClick={e => scrollTo('certificates', e)}>
          <FileBadge className="nav-icon" /> CERT
        </a>
        <a href="#education" className="nav-link" onClick={e => scrollTo('education', e)}>
          <BookOpen className="nav-icon" /> EDU
        </a>
        <a href="#social" className="nav-link" onClick={e => scrollTo('social', e)}>
        ...
        <a href="#contact" className="nav-link" onClick={e => scrollTo('contact', e)}>
